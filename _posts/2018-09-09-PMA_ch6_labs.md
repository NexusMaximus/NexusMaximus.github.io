...
1. What is the major code construct found in the only subroutine called by ``main``?
	...
	![1_6.1.PNG](/files/ch6sc/1_6.1.PNG)
...
3. What does the second subroutine called by ``main`` do?
	...
	![6_6.2.PNG](/files/ch6sc/6_6.2.PNG)
...
4. What type of code construct is used in this subroutine?
	...
	![2_6.2.PNG](/files/ch6sc/2_6.2.PNG)
...
5. Are there any network-based indicators for this program?
	...
	![3_6.2.PNG](/files/ch6sc/3_6.2.PNG)

	And we can see what the rest of the data is by clicking szUrl. 

	![4_6.2.PNG](/files/ch6sc/4_6.2.PNG)
...
1. Compare the calls in ``main`` to Lab 6.2's ``main`` method. What is the new funtion called from ``main``?
	...
	![5_6.3.PNG](/files/ch6sc/5_6.3.PNG)
...
3. What major code construct does this function contain?
	...
	![7_6.3switch.PNG](/files/ch6sc/7_6.3switch.PNG)
...
4. What can this function do?
	...
	![8_6.3.PNG](/files/ch6sc/8_6.3.PNG)
...
3. What's the difference between this lab's parse HTML function and those of the previous labs?
	...
	![9_6.4.PNG](/files/ch6sc/9_6.4.PNG)
