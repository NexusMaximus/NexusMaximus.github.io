...
First, I opened the files in OllyDbg and Ida. I looked through main() on Ida to see what sorts of things we could expect to see, and did a little bit of initial commenting. 

![01_initial.PNG](/files/ch9sc/01_startup.PNG)
...
![processArgvLast](/files/ch9sc/02_processArgvLast.PNG)
...
![step2](/files/ch9sc/03_step2.PNG)
...
![step3and4](/files/ch9sc/04_step3and4.PNG)
...
![prePatchingObservation](/files/ch9sc/05_prePatchingObservation.PNG)
...
![patched](/files/ch9sc/06_patched.PNG)
...
3. When you use OllyDbg to debug Lab09-03.exe, what is the assigned base address for all three DLL files?
